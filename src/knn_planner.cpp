...
class UnionGoalSampleableRegion : public ompl::base::GoalSampleableRegion {
    ...
    std::vector<std::shared_ptr<const ompl::base::GoalSampleableRegion>> goals;
...
visitAllKnn(const std::vector<Apple> &apples, const moveit::core::RobotState &start_state, const size_t k,
