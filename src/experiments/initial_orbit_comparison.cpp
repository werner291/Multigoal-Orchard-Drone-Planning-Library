...
public:
	...
	[[nodiscard]] Eigen::Vector3d at_t(double t) const {
...
public:
	...
	CylindricalOrbitPath(const Eigen::Vector3d &center,
						 double radius,
						 double height,
						 double startTheta,
						 double endTheta)
			: center(center), radius(radius), height(height), start_theta(startTheta), end_theta(endTheta) {
	}
...
public:
	...
	SphericalOscillatingOrbitPath(const Eigen::Vector3d &center, double radius, double startTheta, double endTheta)
			: center(center), radius(radius), start_theta(startTheta), end_theta(endTheta) {
	}
...
public:
	...
	HelicalOrbit(const Eigen::Vector3d &center, double radius, double height, double startTheta, double endTheta)
			: center(center), radius(radius), height(height), start_theta(startTheta), end_theta(endTheta) {
	}
