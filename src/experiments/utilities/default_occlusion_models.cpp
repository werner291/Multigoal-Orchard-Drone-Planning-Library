...
const std::array<std::pair<std::string, CanSeeAppleFnFactory>, 12> OCCLUSION_MODELS = {
		...
		{"alpha_occlusion_end_effector", [](const TreeMeshes &meshes) {
		...
		{"alpha_occlusion_base_link", [](const TreeMeshes &meshes) {
		...
		{"mesh_and_angle_end_effector", [](const TreeMeshes &meshes) {
		...
		{"mesh_and_angle_base_link", [](const TreeMeshes &meshes) {
		...
		{"alpha_and_angle_end_effector", [](const TreeMeshes &meshes) {
		...
		{"alpha_and_angle_base_link", [](const TreeMeshes &meshes) {
