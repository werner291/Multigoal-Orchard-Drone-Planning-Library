...
std::vector<std::string> mgodpl::experiments::getAndAnnotateTreeModels(Json::Value &results) {
...
mgodpl::experiments::TreeModelBenchmarkData
mgodpl::experiments::loadBenchmarkTreemodelData(const std::string &tree_model_name) {
...
std::vector<TreeModelBenchmarkData> mgodpl::experiments::loadAllTreeBenchmarkData(Json::Value &results) {
