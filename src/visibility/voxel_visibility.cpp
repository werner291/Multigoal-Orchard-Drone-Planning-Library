...
namespace mgodpl {
	...
	void voxel_visibility::cast_occlusion(const AABBGrid &grid,
		...
		const std::array<Ray, 3> rays{occluded_ray(eye, triangle.a, 0.0/*cell_size*/),
									  occluded_ray(eye, triangle.b, 0.0/*cell_size*/),
									  occluded_ray(eye, triangle.c, 0.0/*cell_size*/),};
